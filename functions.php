<?php
/**
 * Panama Press functions and definitions
 *
...
if ( ! function_exists( 'panama_news_setup' ) ) :
	...
	function panama_news_setup() {
		 ...
		 * If you're building a theme based on Panama Press, use a find and replace
		 * to change 'panama-press' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'panama-press', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'panama-press' ),
		) );
...
function panama_news_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'panama-press' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'panama-press' ),
...
function panama_news_scripts() {
	wp_enqueue_style( 'panama-press-style', get_stylesheet_uri() );
